...
export const StayLogo = ({
  ...
  const getThemeColors = () => {
    switch (themeVariant) {
      case 'hearth':
        return {
          primary: 'url(#hearthEmberShared)',
          secondary: 'url(#hearthGoldShared)',
          accent: 'url(#hearthEarthShared)',
          glow: 'rgba(251, 146, 60, 0.4)',
        };
      case 'midnight':
        return {
          primary: 'url(#cyberNeonShared)',
          secondary: 'url(#cyberTealShared)',
          accent: 'url(#cyberTealShared)',
          glow: 'rgba(20, 184, 166, 0.4)',
        };
      case 'sovereign':
        return {
          primary: 'url(#sovereignGoldShared)',
          secondary: 'url(#sovereignSilverShared)',
          accent: 'url(#sovereignTitaniumShared)',
          glow: 'rgba(234, 179, 8, 0.3)',
        };
      case 'patriot':
      default:
        return {
          primary: 'url(#patriotCrimsonShared)',
          secondary: 'url(#libertyBlueShared)',
          accent: 'url(#goldSunsetShared)',
    ...
    >
      <style>{`
        ...
        @keyframes stay-pulse-glow {
          0%, 100% { filter: drop-shadow(0 0 4px rgba(37, 99, 235, 0.4)); opacity: 0.7; }
          50% { filter: drop-shadow(0 0 16px rgba(37, 99, 235, 0.9)); opacity: 1; }
        }
      ...
      {!isBlueprint && (
        <div
          ...
          style={{
            background: themeVariant === 'patriot' ? 'radial-gradient(circle, rgba(37,99,235,0.15) 0%, rgba(37,99,235,0.08) 50%, transparent 100%)' :
                        themeVariant === 'hearth' ? 'radial-gradient(circle, rgba(251,146,60,0.18) 0%, rgba(251,191,36,0.08) 50%, transparent 100%)' :
                        themeVariant === 'midnight' ? 'radial-gradient(circle, rgba(20,184,166,0.18) 0%, rgba(6,182,212,0.1) 50%, transparent 100%)' :
                        'radial-gradient(circle, rgba(234,179,8,0.12) 0%, rgba(148,163,184,0.06) 50%, transparent 100%)',
      ...
      <svg viewBox="0 0 100 100" className="w-full h-full relative z-10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          {/* Patriot Gradients */}
          <linearGradient id="patriotCrimsonShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#2563eb" />
            <stop offset="100%" stopColor="#0f766e" />
          </linearGradient>
          <linearGradient id="libertyBlueShared" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#2563eb" />
            <stop offset="100%" stopColor="#38bdf8" />
          </linearGradient>
          <linearGradient id="goldSunsetShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#fbbf24" />
            <stop offset="100%" stopColor="#ea580c" />
          </linearGradient>

          {/* Hearth Gradients */}
          <linearGradient id="hearthEmberShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#ea580c" />
            <stop offset="100%" stopColor="#7c2d12" />
          </linearGradient>
          <linearGradient id="hearthGoldShared" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#f59e0b" />
            <stop offset="100%" stopColor="#fef08a" />
          </linearGradient>
          <linearGradient id="hearthEarthShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#d97706" />
            <stop offset="100%" stopColor="#451a03" />
          </linearGradient>

          {/* Midnight Gradients */}
          <linearGradient id="cyberNeonShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#0f766e" />
            <stop offset="100%" stopColor="#2563eb" />
          </linearGradient>
          <linearGradient id="cyberTealShared" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#06b6d4" />
            <stop offset="100%" stopColor="#22c55e" />
          </linearGradient>

          {/* Sovereign Gradients */}
          <linearGradient id="sovereignGoldShared" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#eab308" />
            <stop offset="100%" stopColor="#854d0e" />
          </linearGradient>
          <linearGradient id="sovereignSilverShared" x1="0%" y1="100%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#94a3b8" />
            <stop offset="100%" stopColor="#f1f5f9" />
          </linearGradient>
          <linearGradient id="sovereignTitaniumShared" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <g
          ...
          style={{ opacity: getOpacity('compass'), filter: getGlowFilter('compass') }}
          stroke={themeVariant === 'sovereign' ? 'url(#sovereignSilverShared)' : themeVariant === 'hearth' ? 'url(#hearthEarthShared)' : themeVariant === 'midnight' ? 'url(#cyberNeonShared)' : 'url(#libertyBlueShared)'}
        >
          <circle
            cx="50"
            cy="50"
            ...
            strokeDasharray="4,6"
            className={isBlueprint ? "" : isTectonic ? "stay-orbit-ring-ccw-slow" : "stay-orbit-ring-ccw"}
          />
          <circle
            cx="50"
            cy="50"
            r="40"
            stroke={themeVariant === 'sovereign' ? 'url(#sovereignGoldShared)' : themeVariant === 'hearth' ? 'url(#hearthGoldShared)' : themeVariant === 'midnight' ? 'url(#cyberTealShared)' : 'url(#patriotCrimsonShared)'}
            strokeWidth="0.8"
            strokeOpacity={isBlueprint ? "0.6" : "0.25"}
            strokeDasharray="40,2,10,2"
            className={isBlueprint ? "" : isTectonic ? "stay-orbit-ring-cw-slow" : "stay-orbit-ring-cw"}
          />
          {!isBlueprint && (
            <circle
              cx="50"
        ...
        <g
          className="transition-all duration-500"
          style={{ opacity: getOpacity('constellation'), filter: getGlowFilter('constellation') }}
        >
          <g stroke="currentColor" strokeWidth="0.8" strokeOpacity={isBlueprint ? "0.4" : "0.15"} className="text-foreground/40">
          ...
          {!isBlueprint && (
            <g stroke={themeVariant === 'midnight' ? '#00f6ff' : themeVariant === 'hearth' ? '#fb923c' : '#38bdf8'} strokeWidth="1.2" strokeLinecap="round">
              <line x1="50" y1="16" x2="81" y2="38.5" strokeDasharray="10, 20" className="stay-packet-flow-line" style={{ animationDelay: '0s' }} />
              <line x1="81" y1="38.5" x2="69" y2="75" strokeDasharray="10, 20" className="stay-packet-flow-line" style={{ animationDelay: '0.3s' }} />
              <line x1="69" y1="75" x2="31" y2="75" strokeDasharray="10, 20" className="stay-packet-flow-line" style={{ animationDelay: '0.6s' }} />
              <line x1="31" y1="75" x2="19" y2="38.5" strokeDasharray="10, 20" className="stay-packet-flow-line" style={{ animationDelay: '0.9s' }} />
              <line x1="19" y1="38.5" x2="50" y2="16" strokeDasharray="10, 20" className="stay-packet-flow-line" style={{ animationDelay: '1.2s' }} />
            </g>
          )}
        </g>
        ...
        <g
          className="transition-all duration-500"
          style={{ opacity: getOpacity('anchor'), filter: getGlowFilter('anchor') }}
        >
          {isBeacon && (
            <path
          ...
          <circle
            ...
            cy="46"
            r="8"
            fill={themeVariant === 'sovereign' ? 'url(#sovereignTitaniumShared)' : '#000000'}
            fillOpacity="0.35"
            stroke="#ffffff"
            strokeWidth="0.6"
            strokeOpacity="0.4"
        ...
        >
          <g className="stay-animate-star-glow-1">
            <circle cx="50" cy="16" r="3.5" fill="#ffffff" stroke={colors.secondary} strokeWidth="1.5" />
            <polygon points="50,13 51,15 53.5,16 51,17 50,19 49,17 46.5,16 49,15" fill="#ffffff" className="origin-center" />
          </g>

          <circle cx="81" cy="38.5" r="3" fill={colors.primary} className="stay-animate-pulse-dot" style={{ animationDelay: '0.4s' }} />
          <circle cx="69" cy="75" r="3.2" fill={colors.accent} className="stay-animate-pulse-dot" style={{ animationDelay: '0.8s' }} />
          <circle cx="31" cy="75" r="3.2" fill={colors.secondary} className="stay-animate-pulse-dot" style={{ animationDelay: '1.2s' }} />
          <circle cx="19" cy="38.5" r="3" fill={colors.primary} className="stay-animate-pulse-dot" style={{ animationDelay: '1.6s' }} />
        </g>
      </svg>
    </div>
  );
