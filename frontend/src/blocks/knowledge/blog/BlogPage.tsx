...
const BlogPage = () => {
  ...
  if (loading) {
    return (
      <AquaticBackground className="flex items-center justify-center py-16 md:py-24 relative overflow-hidden">
  ...
  return (
    <AquaticBackground className="pb-24 relative overflow-hidden">
      ...
      <section className="w-full relative py-16 md:py-24 flex flex-col items-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500 via-blue-500 to-teal-500 dark:from-blue-400 dark:via-blue-400 dark:to-teal-400" style={{ opacity: 0.08 }} />
        ...
        >
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-blue-600 to-teal-600 dark:from-blue-400 dark:via-blue-400 dark:to-teal-400 bg-clip-text text-transparent leading-tight">
              Consciousness: <br />
                ...
                <div className="relative flex flex-col lg:flex-row items-center gap-8">
                  <div className="flex-1 text-left">
                    <motion.div className="inline-flex items-center gap-2 mb-4">
                      <Badge variant="secondary" className="bg-gradient-to-r from-blue-500 to-blue-500 text-white border-0">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Link to={"/blog/" + featuredPost.id}>
                        <Button
                          size="lg"
                          className="group bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300"
                        >
                  ...
                  >
                    <div className="w-48 h-48 md:w-64 md:h-64 rounded-3xl bg-gradient-to-br from-blue-500/20 via-blue-500/20 to-teal-500/20 flex items-center justify-center relative overflow-hidden group-hover:shadow-2xl transition-shadow duration-500">
                      <motion.span
      ...
      {/* Search and Filters */}
      <section className="w-full flex justify-center sticky top-0 z-30 bg-black/30 backdrop-blur-xl border-b border-white/5 shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                ...
                {/* Content */}
                <div className="prose psky-lg dark:psky-invert max-w-none mb-8">
