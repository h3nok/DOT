        ...
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <GlassCard className="p-8 mb-12">
              <h2 className="text-2xl font-inter font-medium mb-4">My Story</h2>
              <p className="font-inter font-light text-muted-foreground leading-relaxed">
              ...
              <p className="font-inter font-light text-muted-foreground leading-relaxed mt-4">
        ...
        <ReadingContainer>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {supportTiers.map((tier) => {
              ...
              return (                <GlassCard key={tier.id} className="card-hover">
