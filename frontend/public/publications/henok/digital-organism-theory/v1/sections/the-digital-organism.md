...
DOT does not begin by denying matter, neuroscience, or the physical world. It begins by refusing to explain away the presence to which the physical world appears. We can correlate experience with brain activity, manipulate it through chemicals, alter it through injury, and interrupt its ordinary expression through anesthesia. These facts are indispensable. But correlation, dependence, and manipulation do not by themselves settle what consciousness ultimately is.

The familiar materialist hypothesis is that consciousness is produced by sufficiently organized physical processes. DOT considers a different hypothesis: consciousness may be fundamental, while the brain and body are the local interface through which consciousness participates in this world.
...
$$S_{t + 1}\  = \ F(S_{t},\ x_{t},\ a_{t},\ \Delta_{t})$$

Here $S_{t}$ is the process state at step $t$, $x_{t}$ is incoming information, $a_{t}$ is the response taken, and $\Delta_{t}$ is the consequential difference carried forward. The update function $F$ is intentionally unspecified. The equation states the architecture already described; it does not identify a physical implementation or establish sentience.

This is a model definition. It identifies the behavior we are trying to understand. It does not yet tell us which systems possess subjective awareness. That question remains open and important. A thermostat responds to information in a minimal sense; that alone does not make it conscious. DOT will need a stronger account of sentience than adaptive response by itself.
...
The first evidence available to consciousness is consciousness occurring.
...
Consciousness research therefore has two legitimate streams of evidence:[¹](/book/digital-organism-theory/references#reference-1)[²](/book/digital-organism-theory/references#reference-2)
...
I observed that my experience was mediated. The same event could enter my life differently depending on what I feared, expected, knew, or was prepared to notice. Attention altered which parts of a situation became available. Repetition turned choices into tendencies. Tendencies began to feel like identity. When an interpretation became emotionally protected, evidence was often recruited to defend it.[³](/book/digital-organism-theory/references#reference-3)[⁴](/book/digital-organism-theory/references#reference-4)[²⁰](/book/digital-organism-theory/references#reference-20)

I observed that the body and inner life were tightly coupled. An unresolved thought could change sleep, muscle tension, digestion, attention, and behavior. A shift in meaning could change the body’s response even when the external event remained the same.[¹⁵](/book/digital-organism-theory/references#reference-15)
...
Persistence through one undivided process would be fragile. Exploration would expose the whole to every failure. Learning would remain narrow because only one path could be tested at a time.
