...
Behind the gate may be pain that was never processed, a possibility that was never explored, a truth that threatened belonging, or a part of the self that learned to remain hidden. Fear is not always an enemy. It may be a protective response that once served a real purpose. But a gate built for an earlier environment can remain closed long after the original danger has passed.
...
The West learned to describe land as a resource, work as labor input, time as money, attention as inventory, nature as raw material, and human beings as units of production, consumption, taxation, military power, and economic growth. It learned to measure nearly everything except the condition of the being doing the measuring.
...
Underneath much of the extractive form is fear:
...
Instead of confronting these fears at the level of the Canvas, civilizations often externalized them and built institutions around them.
...
We then study the behavior produced inside this environment and call it human nature. We see competition, greed, tribalism, domination, and status-seeking and conclude that this is simply what human beings are.
...
But the Canvas feels the contradiction.
...
The distinction allows us to consider an important possibility: the Frame may be exquisitely suited for development even when the society constructed inside it remains confused.

Our present civilization is often more effective at producing workers, consumers, competitors, believers, loyal group members, and predictable identities than clear, fearless, self-aware Little cs. It trains adaptation to the existing Painting more reliably than awareness of the Painting itself.
...
It means bootstrapping is the only available approach.
...
The same principle applies collectively. A civilization cannot wait for perfectly developed people before building better institutions. It also cannot expect better institutions to manufacture coherent people automatically. Little cs must use their present capacities to improve the structures shaping them, while those structures create better conditions for the development of future Little cs.
...
Bootstrapping is not one solution among many.

For an embedded Little c, it is how emergence occurs.
